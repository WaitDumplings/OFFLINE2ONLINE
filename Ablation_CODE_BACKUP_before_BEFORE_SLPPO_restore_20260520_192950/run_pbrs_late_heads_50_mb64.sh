...
LOG_DIR="${ROOT}/LOGS/Codex_Res_pbrs_lateheads50_clean_snapshot_ne128_mb64_repair_progress_objprog_enc512_s75_ntraj50_u50"
...
launch() {
  ...
  local extra_args="$3"
  local seed=2025
  local exp_name="ablation5_routeevent_${variant}_lateheads50_ne128_mb64_repair_progress_objprog_enc512_s75_ntraj50_gpu${gpu}_seed${seed}_u50"
...
echo "[done] launched PBRS late-heads 50-epoch mb64 sweep"
