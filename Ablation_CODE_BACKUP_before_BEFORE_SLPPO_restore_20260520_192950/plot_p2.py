...
SERIES = [
    ("Exp3 soft gate baseline", "gpu0_p2_exp3_softgate_full"),
    ("Entropy fork", "gpu1_p2_exp3_entropyfork"),
    ("Feasible-count fork", "gpu2_p2_exp3_feasiblefork"),
    ("Route-structure fork", "gpu3_p2_exp3_routefork"),
]
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Plot RGAE Priority-2 decision-fork gate ablation curves.")
    ...
    csv_path = out_dir / "p2_fork_eval_points.csv"
    ...
    specs = [
        ("best_of_8_objective.png", "best_of_8", "objective", "Objective (-100 * eval reward, lower is better)", "RGAE P2 Decision-Fork Best-of-8 Objective", (900, 1050)),
        ("trajectory_avg_objective.png", "trajectory_avg", "objective", "Objective (-100 * eval reward, lower is better)", "RGAE P2 Decision-Fork Trajectory-Average Objective", (980, 1120)),
        ("best_of_8_avg_cs.png", "best_of_8", "avg_cs", "Average charging station visits", "RGAE P2 Decision-Fork Best-of-8 CS Usage", None),
        ("trajectory_avg_avg_cs.png", "trajectory_avg", "avg_cs", "Average charging station visits", "RGAE P2 Decision-Fork Trajectory-Average CS Usage", None),
    ]
