...
SERIES = [
    ("Exp3 symmetric clip", "gpu0_p3_exp3_softgate_sym"),
    ("AsymClip 0.30", "gpu1_p3_exp3_asym30"),
    ("AsymClip 0.40", "gpu2_p3_exp3_asym40"),
    ("Archive-only AsymClip 0.40", "gpu3_p3_exp3_archive_asym40"),
]
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Plot RGAE Priority-3 asymmetric clipping ablation curves.")
    ...
    csv_path = out_dir / "p3_asymclip_eval_points.csv"
    ...
    specs = [
        ("best_of_8_objective.png", "best_of_8", "objective", "Objective (-100 * eval reward, lower is better)", "RGAE P3 Asymmetric Clipping Best-of-8 Objective", (900, 1050)),
        ("trajectory_avg_objective.png", "trajectory_avg", "objective", "Objective (-100 * eval reward, lower is better)", "RGAE P3 Asymmetric Clipping Trajectory-Average Objective", (980, 1120)),
        ("best_of_8_avg_cs.png", "best_of_8", "avg_cs", "Average charging station visits", "RGAE P3 Asymmetric Clipping Best-of-8 CS Usage", None),
        ("trajectory_avg_avg_cs.png", "trajectory_avg", "avg_cs", "Average charging station visits", "RGAE P3 Asymmetric Clipping Trajectory-Average CS Usage", None),
    ]
