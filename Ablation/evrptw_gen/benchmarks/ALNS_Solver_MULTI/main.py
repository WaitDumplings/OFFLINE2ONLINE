...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        required=False,
        default="../../../dataset/unanchored/Cus_50/buffer/solomon/",
    ...
    parser.add_argument(
        "--save_log_path",
        type=str,
        default="./logs3_Cus50_1000iter_new",
    ...
    for file in tqdm(files, desc="Processing instances"):
        ...
        if args.skip_frozen and prev_state is not None:
            ...
            prev_max_iters = int(prev_state.get(
                "max_iters",
                getattr(
                    ALNS_Solver(instance, search_profile=args.search_profile),
                    "max_iters",
                    10**9,
                ),
            ))
